      ...
      <div className="grid grid-cols-1 gap-0 md:grid-cols-4 md:gap-x-5">
        <div className="col-span-1">
          <Image
            ...
            objectFit="fill"
            src="https://res.cloudinary.com/alexmangir/image/upload/v1662912164/self_wa3t88.jpg"
            placeholder="blur"
            blurDataURL="https://res.cloudinary.com/alexmangir/image/upload/v1662912164/self_wa3t88.jpg"
            width={260}
            height={260}
            layout="responsive"
            alt={'article cover'}
